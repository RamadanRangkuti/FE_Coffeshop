  ...
  return(
    ...
    <section className="lg md:flex md:w-[80%] md:mx-auto">
      <div className="md:flex flex-col md:w-[30%] border shadow items-center pb-[30px]">
        ...
        <Link to="/product/admin/add" className="flex flex-col w-full items-center pt-12">
          <button className="text-[#6A4029] bg-[#FFBA33] p-3 px-20 rounded-lg font-bold">Add New Promo</button>
        </Link>
      </div>
      ...
      <div className="flex flex-col md:w-[70%] border shadow">
       ...
       <Link to="/products/admin/add" className="flex flex-col w-full items-center pt-12">
          <button className="text-white bg-[#6A4029] p-3 w-[80%] rounded-lg font-bold">Add New Product</button>
       </Link>
      </div>
    </section>
